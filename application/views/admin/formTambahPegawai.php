  	...
  	<div class="card-body">
  		<form method="POST" action="<?php echo base_url('admin/DataPegawai/tambahDataAksi') ?>" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<?php echo form_error('nik','<div class="text-danger small">') ?>
			</div>

			<div class="form-group">
				<label>Nama Pegawai</label>
				<input type="text" name="nama_pegawai" class="form-control">
				<?php echo form_error('nama_pegawai','<div class="text-danger small">') ?>
			</div>
			...
			<div class="form-group">
				...
				<?php echo form_error('tanggal_masuk','<div class="text-danger small">') ?>
			</div>
			...
			<div class="form-group">
				...
				<?php echo form_error('status','<div class="text-danger small">') ?>
			</div>
